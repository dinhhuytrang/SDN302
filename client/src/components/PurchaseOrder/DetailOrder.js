...
const DetailOrder = () => {
    ...
    const fetchData = async () => {
        try {
            const orderInfoApi = await axios.get(`${BASE_URL}/api/orders/getOrderInfo/${idOrder}`)
            setOrderInfo(orderInfoApi.data)
            console.log(orderInfoApi.data);

            const orderItemApi = await axios.get(`${BASE_URL}/api/orders/getItemOfOrder/${idOrder}`)
            setOrderItem(orderItemApi.data)
            console.log(orderItemApi.data);
